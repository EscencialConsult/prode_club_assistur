  ...
  return (
    ...
    style={{ 
      ...
      <style>{`
        ...
        @keyframes shimmer {
          0%, 100% { 
            boxShadow: 0 0 20px rgba(78, 140, 255, 0.3), 0 0 40px rgba(78, 140, 255, 0.1);
          }
          50% { 
            boxShadow: 0 0 30px rgba(78, 140, 255, 0.5), 0 0 60px rgba(78, 140, 255, 0.2);
          }
        }
      ...
      <div className="absolute w-80 h-80 rounded-full pointer-events-none"
        style={{
          background: 'radial-gradient(circle, rgba(78, 140, 255, 0.12) 0%, transparent 70%)',
          filter: 'blur(70px)',
      ...
      <div className="relative flex flex-col items-center gap-7 z-10 px-8">
        ...
        <div className="relative w-40 h-40">
          ...
          <div className="absolute inset-0 rounded-full border-2 opacity-60"
            style={{
              borderColor: 'rgba(78, 140, 255, 0.4)',
              boxShadow: '0 0 15px rgba(78, 140, 255, 0.2)',
          ...
          <div className="absolute rounded-full border-2 opacity-85"
            style={{
              inset: '14px',
              borderColor: '#4e8cff',
              boxShadow: '0 0 25px rgba(78, 140, 255, 0.3), inset 0 0 15px rgba(78, 140, 255, 0.05)',
          ...
          <div className="absolute left-1/2 -translate-x-1/2 w-0.5 rounded-full pointer-events-none overflow-hidden"
            style={{
              height: '140px',
              top: '-20px',
              background: 'linear-gradient(180deg, transparent 0%, rgba(78, 140, 255, 0.6) 50%, transparent 100%)',
          ...
          <div className="absolute rounded-full"
            style={{
              inset: '48px',
              background: 'linear-gradient(135deg, rgba(78, 140, 255, 0.25) 0%, rgba(78, 140, 255, 0.08) 100%)',
              boxShadow: '0 0 40px rgba(78, 140, 255, 0.4), inset 0 0 20px rgba(255, 255, 255, 0.1)',
          ...
          <div className="absolute top-1/2 left-1/2 w-2 h-2 rounded-full -translate-x-1/2 -translate-y-1/2"
            style={{
              background: 'radial-gradient(circle, rgba(78, 140, 255, 1) 0%, rgba(78, 140, 255, 0.6) 100%)',
              boxShadow: '0 0 12px rgba(78, 140, 255, 0.9)',
              transformOrigin: '0 0',
        ...
        <div className="text-center relative">
          <p className="font-semibold text-sm tracking-wider uppercase" 
            style={{ 
              color: '#4e8cff',
              textShadow: '0 0 15px rgba(78, 140, 255, 0.4)',
          ...
          <div className="flex gap-2 justify-center mt-3.5">
            <div className="w-1.5 h-1.5 rounded-full"
              style={{ 
                background: 'linear-gradient(135deg, #4e8cff 0%, rgba(78, 140, 255, 0.7) 100%)',
                boxShadow: '0 0 10px rgba(78, 140, 255, 0.5)',
