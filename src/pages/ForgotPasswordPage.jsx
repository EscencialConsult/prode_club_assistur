            ...
            {done ? (
              ...
              <div className="text-center py-2">
                <div
                  ...
                  style={{
                    ...
                    border: '2px solid rgba(78,140,255,.45)',
                  }}
                >
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#4e8cff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <Link
                  ...
                  style={{ color: '#4e8cff', textDecoration: 'none' }}
                  onMouseEnter={e => { e.currentTarget.style.color = '#4e8cff' }}
                  onMouseLeave={e => { e.currentTarget.style.color = '#4e8cff' }}
                >
                  ← Volver al login
                </Link>
              </div>
              ...
              <>
                ...
                <div className="h-px mb-6"
                  style={{ background: 'linear-gradient(90deg, transparent, rgba(78,140,255,.2) 50%, transparent)' }} />
