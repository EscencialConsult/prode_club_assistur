            ...
            {!validando && !tokenValido && (
              <div className="text-center py-2">
                ...
                <Link
                  ...
                  style={{ background: '#4e8cff', color: '#05090f', boxShadow: '0 8px 28px rgba(78,140,255,.3)', textDecoration: 'none' }}
                ...
                <div className="mb-7">
                  ...
                  {userInfo && (
                    <p className="font-body text-sm mt-2" style={{ color: 'rgba(255,255,255,.45)' }}>
                      Hola <span style={{ color: '#4e8cff', fontWeight: 600 }}>{userInfo.nombre}</span>, elegí una contraseña nueva para tu cuenta.
                    </p>
                  )}
                </div>
