    ...
    <div style={{ marginBottom:30, position:'relative' }}>
      ...
      <div style={{ position:'relative', zIndex:1, paddingTop:14 }}>
        ...
        <div style={{
          ...
          background:`linear-gradient(90deg,${C.gold} 0%,rgba(78,140,255,.4) 30%,rgba(78,140,255,0) 80%)`,
        }}/>
      </div>
    </div>
  )
...
function Callout({ type='info', title, children }) {
  const variants = {
    ...
    warn:   { accent:C.goldDk,  bg:'rgba(78,140,255,.08)', ic:'!', tone:'IMPORTANTE' },
...
function Step({ num, title, children }) {
  return (
    <div style={{
      ...
      onMouseEnter={e=>{ e.currentTarget.style.borderColor='rgba(78,140,255,.5)'; e.currentTarget.style.transform='translateX(3px)'; e.currentTarget.style.boxShadow='0 4px 14px rgba(12,24,43,.06)' }}
  ...
  if (variant==='solid') {
    return (
      <button onClick={onClick} style={{
        ...
        boxShadow:'0 6px 18px rgba(78,140,255,.35)',
        transition:'all .18s ease',
      }}
        onMouseEnter={e=>{ e.currentTarget.style.background=C.goldLt; e.currentTarget.style.transform='translateY(-1px)'; e.currentTarget.style.boxShadow='0 8px 22px rgba(78,140,255,.5)' }}
        onMouseLeave={e=>{ e.currentTarget.style.background=C.gold; e.currentTarget.style.transform='none'; e.currentTarget.style.boxShadow='0 6px 18px rgba(78,140,255,.35)' }}>
        {children}
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background:`
          radial-gradient(ellipse 600px 400px at 90% 5%, rgba(78,140,255,.08), transparent 60%),
                ...
                {SECTIONS.filter(s=>s.group===group).map(s=>{
                  ...
                  return (
                    <button key={s.id} onClick={()=>goTo(s.id)} style={{
                      ...
                      background:active?'rgba(78,140,255,.1)':'transparent',
                      border:'none',
                      ...
                      onMouseEnter={e=>{ if(!active){ e.currentTarget.style.background='rgba(78,140,255,.05)' }}}
        ...
        <main ref={contentRef} style={{
          ...
          <header style={{
            ...
            <h1 style={{
              ...
              <span style={{
                color:C.goldDk,
                textShadow:'0 0 32px rgba(78,140,255,.25)',
          ...
          <section id="manual-premios" style={{ marginBottom:48, scrollMarginTop:24 }}>
            ...
            <div style={{
              ...
              {[
                { emoji:'🥇', pos:'1° PUESTO', label:'Ganador principal de la apuesta', accent:C.gold,    bg:'rgba(78,140,255,.08)' },
          ...
          <section id="manual-checklist" style={{ marginBottom:48, scrollMarginTop:24 }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                background:'radial-gradient(circle,rgba(78,140,255,.18),transparent 65%)',
                pointerEvents:'none',
              }}/>
              <div style={{ position:'relative' }}>
                <span style={{
                ...
                <div style={{
                  ...
                  {[
                    ...
                    <div key={i} style={{
                      ...
                      border:'1px solid rgba(78,140,255,.18)',
                      borderRadius:8,
                    }}>
                      <span style={{
              ...
              <div style={{ display:'flex', flexWrap:'wrap', gap:8 }}>
                {[
                  ...
                  <button key={path} onClick={()=>navigate(path)}
                    ...
                    onMouseEnter={e=>{ e.currentTarget.style.borderColor=C.gold; e.currentTarget.style.background='rgba(78,140,255,.08)'; e.currentTarget.style.color=C.goldDk }}
