export default function AdminHeader({ bets = [], pendingUsers = [] }) {
  ...
  const stats = [
    ...
    { label:'Finalizadas',    value:finishedBets,        color:'#0041f0', accent:'rgba(78,140,255,.07)',border:'rgba(78,140,255,.2)',  icon:<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg> },
...
<h1 style={{ 
  ...
  PANEL DE <span style={{ color:'#4e8cff' }}>CONFIGURACIÓN</span>
</h1>
      </div>
