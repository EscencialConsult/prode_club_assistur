        ...
        return (
          <button
            ...
            style={{
              ...
              color: active ? '#4e8cff' : '#6B7280',
              border: active ? '1px solid rgba(78,140,255,0.45)' : '1px solid transparent',
            }}
          >
            ...
            {item.count > 0 && (
              <span
                ...
                style={{
                  background: active ? 'rgba(78,140,255,0.18)' : 'rgba(7,26,58,0.08)',
                  color: active ? '#4e8cff' : '#071A3A',
                }}
              >
                {item.count}
              </span>
