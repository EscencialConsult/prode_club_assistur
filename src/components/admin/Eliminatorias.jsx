    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      {isPro && form.type === 'grupos' && (
        <div className="flex flex-col gap-2 p-3 rounded-xl"
          style={{ border: '1px solid rgba(78,140,255,.25)', background: 'rgba(78,140,255,.04)' }}>
          <span className="font-body font-bold text-xs uppercase tracking-widest" style={{ color: '#5f6e8a' }}>
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center justify-between">
          ...
          <span className="font-body text-xs" style={{ color: '#a8b2c4' }}>
            <span className="font-bold" style={{ color: '#0041f0' }}>{seleccionados}</span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
              <button
                ...
                style={{
                  ...
                  color: filtroFase === 'todas' ? '#4e8cff' : '#5f6e8a',
                }}
              >
                Todas las fases
              </button>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      color: filtroFase === f ? '#4e8cff' : '#5f6e8a',
                    }}
                  >
                    {LABEL_FASE[f] || f}
                    {terminada && (
        ...
        <div className="flex items-center justify-between gap-2 text-xs font-body">
          <button type="button" onClick={toggleVisibles} disabled={partidosFiltrados.length === 0}
            className="transition-colors disabled:opacity-40" style={{ color: '#0041f0' }}
              ...
              <div key={`${gr.fase}-${gr.jornada}-${gr.grupo}`}>
                <div className="px-3 py-1.5 flex items-center justify-between sticky top-0 z-10"
                  ...
                  <span className="font-body font-semibold uppercase"
                    style={{ fontSize: 10, color: 'rgba(78,140,255,.8)', letterSpacing: '.1em' }}>
                    {header}
                  </span>
                ...
                {gr.partidos.map(m => {
                  ...
                  return (
                    <label key={m.id}
                      ...
                      style={{
                        background: checked ? 'rgba(78,140,255,.08)' : 'transparent',
                    ...
                    >
                      <span className="flex-shrink-0 w-4 h-4 rounded flex items-center justify-center"
                        style={{
                          border: `1.5px solid ${checked ? '#4e8cff' : '#e8dfd0'}`,
                          background: checked ? '#4e8cff' : 'transparent',
                          transition: 'all .15s',
                        }}>
                        {checked && (
