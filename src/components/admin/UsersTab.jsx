          ...
          {pendingUsers.map(u => {
            ...
            return (
              <div key={u.id} className="rounded-2xl p-5 transition-all"
                style={{
                  background: '#fff',
                  border: `1px solid ${isApproving ? '#4e8cff' : '#f0eadb'}`,
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center font-display text-lg"
                      style={{ background: 'linear-gradient(135deg,#0c182b,#17376a)', color: '#4e8cff', boxShadow: '0 4px 12px rgba(12,24,43,.2)' }}>
                          ...
                          return (
                            <button key={opt.val} type="button"
                              ...
                              style={{
                                ...
                                color: isActive ? '#4e8cff' : '#0c182b',
                              }}>
                              <p className="font-body font-semibold text-sm">{opt.label}</p>
                              <p className="font-body text-xs mt-0.5" style={{ color: isActive ? 'rgba(78,140,255,.6)' : '#5f6e8a' }}>{opt.desc}</p>
                            </button>
                          )
                        })}
                      </div>
                    ...
                    <div>
                      ...
                      {areas.length === 0 ? (
                        <p className="text-xs font-body p-3 rounded-xl"
                          style={{ background: 'rgba(78,140,255,.06)', border: '1px solid rgba(78,140,255,.2)', color: '#0041f0' }}>
