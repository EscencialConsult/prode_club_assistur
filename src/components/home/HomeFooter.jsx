    ...
    <footer style={{ background: '#05090f', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth:1200, margin:'0 auto', padding:'3.5rem 1.5rem 2.5rem' }}>
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(220px,1fr))', gap:'2.5rem' }}>
          ...
          <div>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:'1rem', marginBottom:'1.25rem' }}>
              <img
                ...
                alt="ONE"
                style={{ height:34, width:'auto', filter:'drop-shadow(0 2px 16px rgba(78,140,255,.3))', opacity:.96 }}
              />
              <div style={{ width:1, height:36, background:'rgba(78,140,255,.22)', flexShrink:0 }}/>
            ...
            <div style={{ display:'flex', gap:'.6rem' }}>
              <a href="https://wa.me/5491133588062" target="_blank" rel="noopener noreferrer"
                ...
                onMouseEnter={e=>{ e.currentTarget.style.background='rgba(78,140,255,.12)'; e.currentTarget.style.borderColor='rgba(78,140,255,.3)' }}
          ...
          {/* Col 2: Servicios */}
          <div>
            <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:'.65rem', fontWeight:700, textTransform:'uppercase', letterSpacing:'.2em', color:'rgba(78,140,255,.7)', margin:'0 0 1.1rem' }}>
              Servicios
            </p>
              ...
              {[
                ...
                <li key={label}>
                  <span style={{ fontFamily:"'DM Sans',sans-serif", fontSize:'.84rem', color:'rgba(255,255,255,.45)', display:'inline-flex', alignItems:'center', gap:'.4rem' }}>
                    <span style={{ width:4, height:4, borderRadius:'50%', background:'rgba(78,140,255,.3)', flexShrink:0 }}/>
                    {label}
                  </span>
                </li>
              ))}
      ...
      <div style={{ maxWidth:1200, margin:'0 auto', padding:'0 1.5rem' }}>
        <div style={{ height:1, background:'linear-gradient(90deg,transparent,rgba(78,140,255,.2) 20%,rgba(78,140,255,.2) 80%,transparent)' }}/>
      </div>
