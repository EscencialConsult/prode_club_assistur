...
export default function HomeNav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-300"
      style={scrolled
        ? { background: 'rgba(5,9,15,.96)', backdropFilter: 'blur(16px)', boxShadow: '0 1px 0 rgba(78,140,255,.2),0 8px 24px rgba(0,0,0,.3)', padding: '.7rem 0' }
      ...
      {open && (
        <div className="lg:hidden mt-2 mx-4 rounded-xl p-4 space-y-1"
          style={{ background: 'rgba(12,24,43,.97)', backdropFilter: 'blur(16px)', border: '1px solid rgba(78,140,255,.35)' }}>
          {links.map(([href, label]) => (
