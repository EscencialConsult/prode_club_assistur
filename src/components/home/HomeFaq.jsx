        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="lg:sticky" style={{ top: '7rem' }}>
            <span className="inline-flex items-center gap-2 font-body font-bold text-xs uppercase tracking-widest px-4 py-2 rounded-full mb-6"
              style={{ border: '1.5px solid #4e8cff', color: '#0041f0', background: 'rgba(78,140,255,.12)' }}>
              Ayuda
            </span>
            ...
            {FAQS.map(({ q, a }, i) => {
              ...
              return (
                <div 
                  ...
                  style={{
                    border: isOpen ? '2px solid #4e8cff' : isHovered ? '2px solid #f0eadb' : '2px solid transparent',
                    boxShadow: isOpen 
                      ? '0 8px 24px rgba(78,140,255,.18), 0 2px 8px rgba(78,140,255,.1)' 
                      : isHovered 
                ...
                >
                  <button
                    ...
                    style={{ background: isOpen ? 'rgba(78,140,255,.03)' : 'transparent' }}
                  ...
                  >
                    ...
                    <span 
                      ...
                      style={isOpen 
                        ? { background: '#4e8cff', color: '#05090f', transform: 'rotate(180deg)' } 
