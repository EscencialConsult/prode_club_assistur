      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 1.5rem' }}>
        ...
        <div className="text-center mb-14">
          <span className="inline-flex items-center gap-2 font-body font-bold text-xs uppercase tracking-widest px-4 py-1.5 rounded-full mb-5"
            style={{ border: '1px solid #4e8cff', color: '#0041f0', background: 'rgba(78,140,255,.1)' }}>
            Cómo funciona
          </span>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {STEPS.map(({ n, title, desc, icon }) => (
            <div key={n} className="relative rounded-2xl p-7 bg-white transition-all duration-300"
              ...
              onMouseEnter={e => { e.currentTarget.style.borderColor = '#4e8cff'; e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.boxShadow = '0 14px 36px rgba(12,24,43,.1)' }}
            ...
            >
              <div className="font-display leading-none mb-4 select-none" style={{ fontSize: '5.5rem', color: '#4e8cff', opacity: .70 }}>
                {n}
              </div>
        ...
        <div className="text-center">
          <Link to="/register"
            ...
            style={{ background: '#4e8cff', color: '#05090f', boxShadow: '0 8px 24px rgba(78,140,255,.28)', textDecoration: 'none' }}
