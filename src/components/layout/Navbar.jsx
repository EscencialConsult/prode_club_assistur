...
export default function Navbar() {
  ...
  const linkStyle = isActive => isActive
    ? { background: 'rgba(78,140,255,.15)', color: '#4e8cff', border: '1px solid rgba(78,140,255,.3)' }
  ...
  return (
    <nav
      ...
      style={{
        ...
        borderBottom: '1px solid rgba(78,140,255,.12)',
    ...
    >
      <div className="max-w-6xl mx-auto px-4 md:px-6 h-16 flex items-center gap-4">
        ...
        <Link to="/dashboard" className="flex items-center gap-3 flex-shrink-0 min-w-0">
          ...
          <div className="w-px h-5 hidden sm:block" style={{ background: 'rgba(78,140,255,.25)' }} />
          <img
          ...
          {isAdmin && ADMIN_LINKS.map(link => (
            <NavLink key={link.to} to={link.to}
              ...
              style={({ isActive }) => isActive
                ? { background: 'rgba(78,140,255,.2)', color: '#4e8cff', border: '1px solid rgba(78,140,255,.4)', fontWeight: 700 }
                : { color: 'rgba(78,140,255,.6)', border: '1px solid transparent' }
              }
            >
              {link.label}
            </NavLink>
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <div className="hidden sm:flex items-center gap-2">
              <div className="w-7 h-7 rounded-full flex items-center justify-center font-display text-xs"
                style={{ background: 'linear-gradient(135deg,#4e8cff,#0041f0)', color: '#05090f', boxShadow: '0 2px 8px rgba(78,140,255,.3)' }}>
